...
STRINGS = {
    ...
    "printer_silent_status": "The printer stopped answering",
    "printer_silent_body": (
        "The printer went quiet partway through and did not "
        "answer for {seconds} seconds, so Pad Zero stopped waiting."
        "\n\nLast step: {step}\n\n"
    ...
    "progress_count": "{doing}, {done} of {total}...",
    "progress_reading_memory": "Reading the printer's memory",
    "progress_saving_backup": "Saving a backup",
    "backup_saved_resetting": "Backup saved, resetting...",
    "reset_written_reading_back": "Reset written, reading the counters back...",
