...
STRINGS = {
    ...
    "printer_silent_status": "La impresora dejó de responder",
    "printer_silent_body": (
        "La impresora se quedó en silencio a mitad del proceso y no "
        "respondió durante {seconds} segundos, así que Pad Zero dejó de esperar."
        "\n\nÚltimo paso: {step}\n\n"
        "Si todavía estaba en la copia, no se cambió nada en la "
        "impresora.\n\n"
        "Prueba esto:\n"
        "1. Apaga la impresora, espera diez segundos, vuelve a "
        "encenderla y deja que termine de arrancar.\n"
        "2. Desconecta el cable USB y vuelve a conectarlo.\n"
        "3. Pulsa Comprobar nivel e inténtalo de nuevo.\n\n"
        "Si se detiene en el mismo punto cada vez, abre una "
        "incidencia en GitHub con el nombre exacto de tu modelo."
    ),
    "step_starting": "iniciando",
    "progress_count": "{doing}, {done} de {total}...",
    "progress_reading_memory": "Leyendo memoria de la impresora",
    "progress_saving_backup": "Guardando una copia",
    "backup_saved_resetting": "Copia guardada, reseteando...",
    "reset_written_reading_back": "Reset escrito, leyendo los contadores otra vez...",
